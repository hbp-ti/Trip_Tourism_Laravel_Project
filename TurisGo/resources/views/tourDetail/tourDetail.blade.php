...
<div class="tour-details">
    ...
    <div class="section-title-container">
        <h3 class="section-title">Train/Bus Tickets</h3>
        <hr class="section-divider" style="background-color: #2081A5;">
    </div>
    <p style="text-align: center; font-size: 1.7rem; margin-bottom: 20px;">Seems like you didn't buy train/bus tickets!</p>
    <div class="button-group">
    <button class="btn btn-primary" style="background-color: #2081A5;">Buy Train Tickets</button>
    <button class="btn btn-primary" style="background-color: #2081A5;">Buy Bus Tickets</button>
    </div>
</div>
